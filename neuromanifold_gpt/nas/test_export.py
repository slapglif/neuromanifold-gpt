...
class TestExportConfig:
    ...
    def test_export_config_creates_file(self, temp_dir, sample_architecture, sample_result):
    ...
    def test_export_config_file_is_valid_python(self, temp_dir, sample_architecture, sample_result):
    ...
    def test_export_config_contains_architecture_params(self, temp_dir, sample_architecture, sample_result):
    ...
    def test_export_config_contains_sdr_params(self, temp_dir, sample_architecture, sample_result):
    ...
    def test_export_config_contains_performance_metrics(self, temp_dir, sample_architecture, sample_result):
    ...
    def test_export_config_filename_generation(self, temp_dir, sample_architecture, sample_result):
...
class TestExportToJson:
    ...
    def test_export_to_json_creates_file(self, temp_dir, sample_architecture, sample_result):
    ...
    def test_export_to_json_valid_json(self, temp_dir, sample_architecture, sample_result):
    ...
    def test_export_to_json_contains_architecture(self, temp_dir, sample_architecture, sample_result):
        ...
        assert data['architecture']['attention_type'] == sample_architecture.attention_type

    def test_export_to_json_contains_metrics(self, temp_dir, sample_architecture, sample_result):
    ...
    def test_export_to_json_with_sdr_params(self, temp_dir, sample_architecture, sample_result):
...
class TestGenerateSummaryReport:
    ...
    def test_generate_summary_creates_file(self, temp_dir, sample_architecture, sample_result):
    ...
    def test_generate_summary_contains_metrics(self, temp_dir, sample_architecture, sample_result):
    ...
    def test_generate_summary_markdown_format(self, temp_dir, sample_architecture, sample_result):
...
class TestExportEdgeCases:
    ...
    def test_export_with_special_characters_in_id(self, temp_dir):
        ...
        result = EvaluationResult(True, 2.0, 7.39, 10_000_000, 60.0, 500.0, "test/arch:001", None)
