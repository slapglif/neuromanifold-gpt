# neuromanifold_gpt/training/lightning_module.py
"""
PyTorch Lightning training module for NeuroManifoldGPT.

Provides:
- NeuroManifoldLitModule: LightningModule wrapper for training
...
class NeuroManifoldLitModule(L.LightningModule):
