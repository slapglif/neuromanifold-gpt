...
def test_continuous_output_head_end_to_end():
    config = ContinuousOutputConfig(embed_dim=32, hidden_dim=64, num_inference_steps=5)
...
def test_sac_policy_shapes():
    from neuromanifold_gpt.model.continuous.sac_policy import SACConfig, SACPolicy
...
def test_ddpg_policy_shapes():
    from neuromanifold_gpt.model.continuous.ddpg_policy import DDPGConfig, DDPGPolicy
