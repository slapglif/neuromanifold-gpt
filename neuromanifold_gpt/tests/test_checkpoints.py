...
class TestExtractValLoss:
    ...
    def test_extract_lightning_format(self):
        ...
        from neuromanifold_gpt.utils.checkpoints import _extract_val_loss

        val_loss = _extract_val_loss("ckpt-000123-1.2345.ckpt")
    ...
    def test_extract_lightning_format_different_step(self):
        ...
        val_loss = _extract_val_loss("ckpt-999999-0.5678.ckpt")
    ...
    def test_extract_loss_underscore_format(self):
        ...
        val_loss = _extract_val_loss("checkpoint_loss_2.3456.pt")
    ...
    def test_extract_loss_hyphen_format(self):
        ...
        val_loss = _extract_val_loss("model-loss-3.1415.pth")
    ...
    def test_extract_val_underscore_format(self):
        ...
        val_loss = _extract_val_loss("checkpoint_val_1.9876.pt")
    ...
    def test_extract_val_hyphen_format(self):
        ...
        val_loss = _extract_val_loss("model-val-0.1234.ckpt")
    ...
    def test_extract_case_insensitive(self):
        ...
        val_loss = _extract_val_loss("checkpoint_LOSS_1.5000.pt")
        assert val_loss == 1.5000

        val_loss = _extract_val_loss("checkpoint_VAL_2.5000.pt")
    ...
    def test_extract_no_match_returns_none(self):
        ...
        val_loss = _extract_val_loss("checkpoint_epoch_10.pt")
    ...
    def test_extract_no_decimal_returns_none(self):
        ...
        val_loss = _extract_val_loss("checkpoint_loss_123.pt")
        assert val_loss is None
...
class TestExtractTrainingStep:
    ...
    def test_extract_lightning_format(self):
        ...
        from neuromanifold_gpt.utils.checkpoints import _extract_training_step

        step = _extract_training_step("ckpt-000123-1.2345.ckpt")
        assert step == 123
    ...
    def test_extract_lightning_format_large_step(self):
        ...
        step = _extract_training_step("ckpt-999999-0.5678.ckpt")
        assert step == 999999
    ...
    def test_extract_step_underscore_format(self):
        ...
        step = _extract_training_step("checkpoint_step_12345.pt")
        assert step == 12345
    ...
    def test_extract_step_hyphen_format(self):
        ...
        step = _extract_training_step("model-step-54321.pth")
        assert step == 54321
    ...
    def test_extract_iter_underscore_format(self):
        ...
        step = _extract_training_step("checkpoint_iter_67890.pt")
        assert step == 67890
    ...
    def test_extract_iter_hyphen_format(self):
        ...
        step = _extract_training_step("model-iter-11111.ckpt")
        assert step == 11111
    ...
    def test_extract_case_insensitive(self):
        ...
        step = _extract_training_step("checkpoint_STEP_1000.pt")
        assert step == 1000

        step = _extract_training_step("checkpoint_ITER_2000.pt")
        assert step == 2000
    ...
    def test_extract_no_match_returns_none(self):
        ...
        step = _extract_training_step("checkpoint_epoch_10.pt")
        assert step is None
...
class TestFormatAge:
    ...
    def test_format_seconds_ago(self):
        ...
        from neuromanifold_gpt.utils.checkpoints import _format_age

        # 30 seconds ago
        timestamp = datetime.now().timestamp() - 30
        age_str = _format_age(timestamp)
...
class TestFormatSize:
    ...
    def test_format_bytes(self):
        ...
        from neuromanifold_gpt.utils.checkpoints import _format_size

        size_str = _format_size(512)
    ...
    def test_format_kilobytes(self):
        ...
        size_str = _format_size(2048)  # 2KB
    ...
    def test_format_megabytes(self):
        ...
        size_str = _format_size(5 * 1024 * 1024)  # 5MB
    ...
    def test_format_gigabytes(self):
        ...
        size_str = _format_size(2 * 1024 * 1024 * 1024)  # 2GB
    ...
    def test_format_fractional_kb(self):
        ...
        size_str = _format_size(1536)  # 1.5KB
...
class TestScanCheckpoints:
    ...
    def test_scan_empty_directory(self, tmp_path):
        ...
        from neuromanifold_gpt.utils.checkpoints import _scan_checkpoints

        checkpoints = _scan_checkpoints(str(tmp_path))
        assert checkpoints == []
    ...
    def test_scan_nonexistent_directory(self):
        ...
        checkpoints = _scan_checkpoints("/nonexistent/path")
        assert checkpoints == []
...
class TestExportCheckpointsMetadata:
    ...
    def test_export_creates_json_file(self, tmp_path):
        ...
        from neuromanifold_gpt.utils.checkpoints import export_checkpoints_metadata
        ...
        export_checkpoints_metadata(str(ckpt_dir), str(output_file))
    ...
    def test_export_nonexistent_directory_raises_error(self, tmp_path):
        ...
        with pytest.raises(ValueError, match="Directory does not exist"):
            export_checkpoints_metadata("/nonexistent/path", str(output_file))
    ...
    def test_export_file_path_raises_error(self, tmp_path):
        ...
        with pytest.raises(ValueError, match="Path is not a directory"):
            export_checkpoints_metadata(str(not_a_dir), str(output_file))
...
class TestListCheckpoints:
    ...
    def test_list_empty_directory(self, tmp_path):
        ...
        from neuromanifold_gpt.utils.checkpoints import list_checkpoints

        filenames = list_checkpoints(str(tmp_path))
        assert filenames == []
