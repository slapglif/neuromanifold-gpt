import pytest
import torch
from neuromanifold_gpt.experiments.ablation import AblationStudy, AblationConfig
from neuromanifold_gpt.data.synthetic_solitons import SolitonDataset
from neuromanifold_gpt.inference.optimization import ContinuousStateCache, StreamingProcessor
