...
BENCHMARK_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'data', 'benchmarks')
...
def download_lambada(cache_dir: Optional[str] = None) -> str:
    ...
    if not os.path.exists(output_file):
        ...
        data_url = 'https://openaipublic.blob.core.windows.net/gpt-2/data/lambada_test.jsonl'
