...
def analyze_parameters():
    ...
    print(f"Base: sdr_size={cfg_base.sdr_size}, sdr_sparsity={cfg_base.sdr_sparsity}, sdr_n_active={cfg_base.sdr_n_active}, context_size={cfg_base.sdr_context_size}")
    ...
    print(f"High Sparsity: sdr_sparsity={cfg_sparse.sdr_sparsity}, sdr_n_active={cfg_sparse.sdr_n_active}")
