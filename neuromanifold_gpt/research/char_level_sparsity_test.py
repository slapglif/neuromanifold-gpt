...
def test_char_sparsity():
    ...
    cfg_standard = NeuroManifoldConfig(sdr_size=2048, sdr_sparsity=0.02, sdr_context_size=5)
    ...
    cfg_char = NeuroManifoldConfig(sdr_size=4096, sdr_sparsity=0.01, sdr_context_size=10)
    
    print(f"Standard: bits={cfg_standard.sdr_size}, active={cfg_standard.sdr_n_active}, sparsity={cfg_standard.sdr_sparsity}")
    print(f"Char-Optim: bits={cfg_char.sdr_size}, active={cfg_char.sdr_n_active}, sparsity={cfg_char.sdr_sparsity}")
