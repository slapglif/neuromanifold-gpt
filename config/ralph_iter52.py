...
# Training - 2050 iterations, balanced schedule
max_iters = 2050
gradient_accumulation_steps = 1
learning_rate = 2e-3
min_lr = 1e-4           # Lower floor for continued learning
weight_decay = 0.1
warmup_iters = 60       # Standard warmup
lr_decay_iters = 2050
grad_clip = 1.0
...
# Eval/logging - reduced to save time
eval_interval = 680
log_interval = 340
eval_iters = 5
sample_interval = 0
